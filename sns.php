...
<div id="socialbox">
    ...
    <a href="http://twitter.com/intent/tweet?url=<?php echo $url_encode ?>&text=<?php echo $title_encode ?>&tw_p=tweetbutton" class="social_item ion-social-twitter mm-twitter mm-ripple">&nbsp;Twitterでツイート</a>
</div>
