...
<?php
  ...
  <a href="<?php the_permalink(); ?>">
    <img src="<?php echo $img_url ?>" alt="streetview" class="card-img-top img-fluid">
  </a>
<?php
  endif;
?>
...
<?php
  elseif ( is_bunkasai_during_open() === null ): ?>
      <p class="card-text text-primary"><i class="fa fa-fw fa-clock-o" aria-hidden="true"></i>&nbsp;開催まで<?php echo get_remaining_days(); ?>日</p>
<?php
  endif;
?>
      <p class="card-text">
